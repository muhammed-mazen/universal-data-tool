...
export var Validator = function Validator(_ref) {
  var images = _ref.images,
    ...
    onValidateAll = _ref.onValidateAll,
    onExit = _ref.onExit,
  ...
  var dispatch = useEventCallback(function(action) {
    if (action.type === "HEADER_BUTTON_CLICKED") {
      ...
      } else if (action.buttonName === "validate") {
        return onValidateAll(without(state, "history"));
      }
    }
