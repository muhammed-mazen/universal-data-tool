...
export var TagsSidebarBox = function TagsSidebarBox(_ref) {
  ...
  var memoImgClsList = useMemo(
    function() {
      return asMutable(
        imageClsList.map(function(c) {
          return {
            value: c,
            label: c,
          };
  ...
  var memoImgTagList = useMemo(
    function() {
      return asMutable(
        imageTagList.map(function(c) {
          return {
            value: c,
            label: c,
          };
